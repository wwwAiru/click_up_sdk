 ...
 * с преждевременным объявлением всех listIds для поиска. Документация {@link TaskClient} актуальна.
 *
...
public interface ListTaskClient extends TaskClient {
     ...
     * <p><b>Опасно!</b></p>
     * <p>
     * Делает несколько запросов в несколько списков ClickUp и возвращает {@link TaskDto}
     * по {@link CustomFieldRequest}, притом количество запросов: <b>N</b>,
     * где N - количество списокв, в которых может находиться задача.
     *
     ...
     */
    List<TasksDto> getTasksByCustomFields(Boolean includeSubtasks,
