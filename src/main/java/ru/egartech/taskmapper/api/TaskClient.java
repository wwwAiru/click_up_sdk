...
public interface TaskClient {
     ...
     * <p><b>Опасно!</b></p>
     *
     * Делает несколько запросов в кликап, для каскадного обновления таски, притом количество запросов: <b>1+N</b> где N - количество кастомных филдов, указанных в {@link UpdateTaskDto}. Запрос может занять какое-то время или исчерпать лимит запосов в кликап (100 в минуту для каждого Free токена).
     *
